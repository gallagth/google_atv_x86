...
$(eval LOCAL_SRC_FILES := app/$(LOCAL_MODULE)/$(LOCAL_MODULE).apk)
$(eval LOCAL_PREBUILT_JNI_LIBS := $(subst $(LOCAL_PATH)/,,$(wildcard $(LOCAL_PATH)/app/$(LOCAL_MODULE)/lib/x86/*.so)))
...
$(eval LOCAL_MODULE_CLASS := APPS)
$(eval LOCAL_SRC_FILES := priv-app/$(LOCAL_MODULE)/$(LOCAL_MODULE).apk)
$(eval LOCAL_PREBUILT_JNI_LIBS := $(subst $(LOCAL_PATH)/,,$(wildcard $(LOCAL_PATH)/priv-app/$(LOCAL_MODULE)/lib/x86/*.so)))
$(eval LOCAL_CERTIFICATE := PRESIGNED)
$(eval include $$(BUILD_PREBUILT))
endef
